...
const HeroSection: React.FC = () => {
  ...
  const whatsappImages = ['/lovable-uploads/1b246895-7c6f-46b3-8b0c-e94da6aeb98d.png', '/lovable-uploads/e16e4953-90df-48ec-8417-2e4b90f5b6c4.png', '/lovable-uploads/7bc3cfe4-eabc-4260-9f1c-433263fbb931.png', '/lovable-uploads/55ce91ff-e7a3-40a9-85d5-8f923e803108.png', '/lovable-uploads/cdb629c8-5e0d-4849-9bab-8aa4dc1d7c22.png', '/lovable-uploads/b9253321-3dd2-4930-b856-1855e51c278b.png'];
            ...
            <div className="relative">
              ...
              <div className="relative z-10 rounded-2xl shadow-xl card-shadow overflow-hidden">
                <div className="bg-black rounded-xl overflow-hidden flex items-center justify-center h-[450px]">
                  <img src={whatsappImages[currentImageIndex]} alt={`WhatsApp Shopping UI ${currentImageIndex + 1}`} className="object-contain" />
                </div>
              </div>
